...
<div class="flex flex-col items-center text-center max-w-xl mx-auto">
    <div class="relative mb-8">
        <span class="text-[8rem] sm:text-[10rem] font-bold text-amber-500/20 dark:text-amber-500/10 select-none leading-none">419</span>
    ...
    <p class="text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
        Form güvenlik anahtarı (oturum) süresi dolduğu için işleminiz kabul edilmedi. Sayfayı yenileyip işlemi tekrar gönderin.
    </p>
    ...
    <div class="w-full max-w-md mx-auto mb-8 text-left p-4 rounded-xl bg-amber-50/80 dark:bg-amber-900/20 border border-amber-200/80 dark:border-amber-800/50">
        ...
        <ul class="text-sm text-amber-800 dark:text-amber-300 space-y-1 list-disc list-inside">
            <li>Formu çok uzun süre açık bıraktınız (genelde 2 saat)</li>
            <li>Tarayıcıda başka sekme ile oturum sonlandı</li>
            <li>Sayfa yenilenmeden birden fazla sekmede aynı form açıktı</li>
            <li>Çerezler veya önbellek temizlendi</li>
        </ul>
    </div>

    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
        <a href="{{ route('ihale.create') }}" class="inline-flex items-center justify-center gap-2 min-h-[48px] px-8 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 shadow-lg shadow-amber-500/25 transition-all duration-200 hover:scale-[1.02] w-full sm:w-auto">
            İhale oluştur sayfasına git
