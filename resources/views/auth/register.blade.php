                ...
                <div class="flex gap-2 flex-wrap items-stretch">
                    <div class="relative flex-1 min-w-[180px]">
                        <input id="password" type="password" name="password" required
                               class="input-touch w-full pr-12 @error('password') border-red-500 @enderror" placeholder="En az 8 karakter">
                    ...
                    <button type="button" id="register-generate-password" class="shrink-0 px-4 py-3 rounded-xl text-sm font-medium bg-zinc-100 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-200 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500/30 whitespace-nowrap">Otomatik oluştur</button>
                </div>
...
(function() {
    ...
    var genPwBtn = document.getElementById('register-generate-password');
    var pwInput = document.getElementById('password');
    var pwConfInput = document.getElementById('password_confirmation');
    if (genPwBtn && pwInput && pwConfInput) {
