...
<div class="max-w-2xl">
    <div class="admin-card p-6">
        <form method="POST" action="{{ route('musteri.bilgilerim.update') }}" class="space-y-5" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="border-t border-slate-200 dark:border-slate-600 pt-6 mt-6">
                ...
                <div class="text-sm text-slate-500 mt-3">
                    ...
                    <form method="POST" action="{{ route('musteri.bilgilerim.send-reset-link') }}" class="inline">
                        @csrf
