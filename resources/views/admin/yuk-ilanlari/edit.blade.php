...
<div class="max-w-2xl">
    <div class="admin-card p-6">
        ...
        <form method="POST" action="{{ route('admin.yuk-ilanlari.destroy', $yuk_ilanlari) }}" class="inline mt-3" onsubmit="return confirm('Bu ilanı silmek istediğinize emin misiniz?');">
            @csrf
            @method('DELETE')
