        ...
        <form method="POST" action="{{ route('admin.ihaleler.update', $ihale) }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="admin-form-group">
                    ...
                    <input type="tel" name="guest_contact_phone" value="{{ old('guest_contact_phone', $ihale->guest_contact_phone) }}" class="admin-input" data-phone-mask placeholder="+90 532 111 22 33">
                </div>
            </div>
