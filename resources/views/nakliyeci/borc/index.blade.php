...
<div class="max-w-2xl">
    <div class="admin-card p-6 mb-6">
        ...
        <p class="text-sm text-slate-500 mb-2">Kabul edilen işlerinizden NakliyePark komisyonu ({{ $company->commission_rate }}%).</p>
        ...
        @if($komisyonBorcu > 0)
            <div class="mt-6 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                <p class="text-sm text-amber-800 dark:text-amber-200">Ödeme ekranı yakında eklenecektir. Borcunuzu ödemek için destek ile iletişime geçebilirsiniz.</p>
                <button type="button" class="admin-btn-primary mt-3" disabled>Ödeme yap (yakında)</button>
            </div>
        @else
