...
<div id="feedback-widget" class="fixed bottom-20 sm:bottom-8 right-4 z-40 flex flex-col items-end gap-0">
    ...
    {{-- Açılır buton --}}
    <button type="button" id="feedback-toggle" class="flex items-center gap-2 px-4 py-3 rounded-full bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium shadow-lg hover:shadow-xl transition-all focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 dark:focus:ring-offset-zinc-900" aria-label="Geri bildirim gönder">
