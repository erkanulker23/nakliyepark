...
<a href="{{ route('admin.defter-api.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.defter-api.*') ? $activeClass : '' }}">
...
<a href="{{ route('admin.room-templates.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.room-templates.*') ? $activeClass : '' }}">
