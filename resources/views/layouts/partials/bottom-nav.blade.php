...
<nav class="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl border-t border-zinc-200 dark:border-zinc-800 safe-area-bottom safe-bottom" aria-label="Ana navigasyon">
    <div class="max-w-6xl mx-auto flex items-center justify-around min-h-[56px] py-2">
        <a href="{{ url('/') }}" class="bottom-nav-item flex flex-col items-center justify-center gap-0.5 min-w-[64px] min-h-[44px] rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:bg-emerald-500/10 {{ request()->routeIs('home') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : '' }}" aria-current="{{ request()->routeIs('home') ? 'page' : null }}">
        ...
        <a href="{{ route('firmalar.index') }}" class="bottom-nav-item flex flex-col items-center justify-center gap-0.5 min-w-[64px] min-h-[44px] rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:bg-emerald-500/10 {{ request()->routeIs('firmalar.*') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : '' }}" aria-current="{{ request()->routeIs('firmalar.*') ? 'page' : null }}">
        ...
        @endif
        <a href="{{ route('defter.index') }}" class="bottom-nav-item flex flex-col items-center justify-center gap-0.5 min-w-[64px] min-h-[44px] rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:bg-emerald-500/10 {{ request()->routeIs('defter.*') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : '' }}" aria-current="{{ request()->routeIs('defter.*') ? 'page' : null }}">
            <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
            <span class="text-[10px] sm:text-xs">Defter</span>
        </a>
        <a href="{{ route('pazaryeri.index') }}" class="bottom-nav-item flex flex-col items-center justify-center gap-0.5 min-w-[64px] min-h-[44px] rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:bg-emerald-500/10 {{ request()->routeIs('pazaryeri.*') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : '' }}" aria-current="{{ request()->routeIs('pazaryeri.*') ? 'page' : null }}">
