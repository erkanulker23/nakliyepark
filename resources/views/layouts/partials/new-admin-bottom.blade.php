...
<nav class="app-bottom" aria-label="Ana menü">
    <div class="app-bottom__inner">
        ...
        <button type="button" class="js-toggle-admin-flyout app-bottom__item{{ request()->routeIs('admin.users.*','admin.musteriler.*','admin.disputes.*','admin.blog.*','admin.settings.*','admin.sitemap.*','admin.notifications.*','admin.profile.*','admin.consent-logs.*','admin.blocklist.*','admin.faq.*','admin.site-contact-messages.*','admin.yuk-ilanlari.*','admin.defter-api.*','admin.reklam-alanlari.*','admin.reviews.*','admin.blog-categories.*','admin.homepage-editor.*','admin.sponsors.*','admin.room-templates.*') ? ' is-active' : '' }}" aria-label="Menüyü aç" aria-haspopup="true" aria-expanded="false">
