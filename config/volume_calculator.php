    ...
    'rooms' => [
        ...
        'yatak_odasi' => [
            ...
            'items' => [
                ...
                ['id' => 'komidin', 'name' => 'Komidin', 'icon' => '🗄️', 'min_m3' => 0.1, 'max_m3' => 0.25],
                ['id' => 'sifonyer', 'name' => 'Şifonyer', 'icon' => '🗄️', 'min_m3' => 0.2, 'max_m3' => 0.5],
        ...
        'mutfak' => [
            'label' => 'Mutfak',
            'items' => [
                ['id' => 'buzdolabi', 'name' => 'Buzdolabı', 'icon' => '❄️', 'min_m3' => 0.5, 'max_m3' => 1.0],
                ['id' => 'firin', 'name' => 'Fırın / Ankastre', 'icon' => '🍳', 'min_m3' => 0.15, 'max_m3' => 0.35],
                ['id' => 'bulaşik_makinesi', 'name' => 'Bulaşık Makinesi', 'icon' => '🧼', 'min_m3' => 0.2, 'max_m3' => 0.4],
                ['id' => 'mutfak_dolabi', 'name' => 'Mutfak Dolabı', 'icon' => '🚪', 'min_m3' => 0.4, 'max_m3' => 1.0],
                ['id' => 'mutfak_masasi', 'name' => 'Mutfak Masası', 'icon' => '🍽️', 'min_m3' => 0.3, 'max_m3' => 0.6],
                ['id' => 'camasir_makinesi', 'name' => 'Çamaşır Makinesi', 'icon' => '👕', 'min_m3' => 0.25, 'max_m3' => 0.45],
                ['id' => 'kurutma_makinesi', 'name' => 'Kurutma Makinesi', 'icon' => '☀️', 'min_m3' => 0.2, 'max_m3' => 0.35],
